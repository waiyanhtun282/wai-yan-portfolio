      ...
      <div className="ct_body py-20">
        <div className="grid grid-cols-1 md:grid-cols-3">
          ...
          <div className="flex md:flex-col gap-10 md:gap-3 justify-center md:items-end" data-aos="zoom-in">
            <a href='https://www.facebook.com/profile.php?id=100042798099129&mibextid=ZbWKwL' className="w-[50px] md:w-[200px] h-[50px] bg-white rounded-full flex items-center cursor-pointer text-black hover:text-kayan transition-all duration-200">
              <FaFacebook size={35} className="ml-2 md:ml-3"/>
              <span className='text-black hidden md:block md:ml-3 text-[18px] cursor-pointer'>Facebook</span>
            </a>
            <a href='https://t.me/MgTayZa' className="w-[50px] md:w-[200px] h-[50px] bg-white rounded-full flex items-center cursor-pointer text-black hover:text-kayan transition-all duration-200">
              <FaTelegram size={35} className="ml-2 md:ml-3"/>
              <span className='text-black hidden md:block md:ml-3 text-[18px] cursor-pointer'>Telegram</span>
            </a>
            <a href='https://github.com/MgHtetMyatAung' className="w-[50px] md:w-[200px] h-[50px] bg-white rounded-full flex items-center cursor-pointer text-black hover:text-kayan transition-all duration-200">
              <FaGithub size={35} className="ml-2 md:ml-3"/>
